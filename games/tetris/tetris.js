...
function drop(){ cur.y++; if (collide(cur)){ cur.y--; merge(cur); clearLines(); cur=spawn(); canHold=true; lockTimer=0; if (collide(cur)){ over=true; GG.addAch(GAME_ID,'Stacked'); } } else { lockTimer=0; } }
